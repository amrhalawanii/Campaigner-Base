import type { Campaign, Agency, CaseStudy } from "../types"

// Re-export types for backward compatibility
export type { Campaign, Agency, CaseStudy }
...
export const campaigns: Campaign[] = [
  ...
  // Generate campaigns for all years from 2000-2025
  ...Array.from({ length: 26 }, (_, yearIndex) => {
    const year = 2000 + yearIndex
    const baseCampaigns = [
      {
        id: 13 + yearIndex * 10,
        title: `${year} Racing Excellence`,
        brand: "Red Bull",
        agency: "Wieden+Kennedy",
        image: "/red-bull-racing-car-on-track.jpg",
        saved: false,
      ...
      {
        id: 19 + yearIndex * 10,
        title: `${year} Educational Innovation`,
        brand: "Duolingo",
        agency: "TBWA",
        image: "/cartoon-characters-educational.jpg",
        saved: false,
      ...
      {
        id: 21 + yearIndex * 10,
        title: `${year} Environmental Impact`,
        brand: "WWF",
        agency: "Ogilvy",
        image: "/underwater-ocean-scene.png",
        saved: false,
